...
export default function MonitoreoGeneralPage({ storeId }: MonitoreoPageProps) {
  ...
  const rankingBase = useMemo(() => {
    ...
    editedRecords.forEach(r => {
      if (!map.has(r.empleadoId)) map.set(r.empleadoId, { id: r.empleadoId, nombre: r.empleadoNombre, total: 0 });
  ...
  return (
    <Box sx={{ backgroundColor: 'transparent', py: 2 }}>
      <Container maxWidth="xl" disableGutters>
        ...
        {/* ----- MODAL DE RANKING (con buscador más abajo, sin subtítulo ni divisor) ----- */}
        <Dialog open={modalEmpleadosOpen} onClose={() => setModalEmpleadosOpen(false)} maxWidth="md" fullWidth PaperProps={{ sx: { borderRadius: 3 } }}>
          ...
          <DialogContent sx={{ p: 3, pt: 2 }}>
            {/**
              *  Buscador y controles. Se usa mt: 4 para bajarlo significativamente.
              *  Se ha eliminado el subtítulo y el divisor.
              */}
