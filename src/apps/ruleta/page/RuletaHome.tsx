  ...
  return (
    ...
    >
      ...
      >
        ...
        <Chip
          icon={<Box sx={{ width: 7, height: 7, borderRadius: '50%', background: '#10B981', ml: 1 }} />}
          label="Activo"
          sx={{ background: '#ECFDF3', border: '1px solid #BBF7D0', color: '#15803D', fontWeight: 600, fontSize: 12 }}
        />
      </Box>
