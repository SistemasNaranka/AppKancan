...
const ProrrogaForm: React.FC<Props> = ({ contractId, open, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    await addProrroga({ contractId: Number(contractId), fechaInicio, descripcion: descripcion || undefined });
  };
          ...
          <Stack spacing={2.5}>
            ...
            <Box>
              ...
              >
                ...
                <LockOutlinedIcon sx={{ fontSize: 15, color: 'text.disabled', ml: 'auto' }} />
              </Box>
            </Box>
            ...
            <Stack direction="row" spacing={1.5} justifyContent="flex-end" pt={0.5}>
              <Button variant="text" onClick={handleClose} color="inherit" sx={{ color: 'text.secondary' }}>
                Cancelar
              </Button>
              <Button
                variant="contained"
