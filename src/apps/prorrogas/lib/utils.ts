...
export const formatDate = (dateStr: string | Date | null): string => {
  ...
  // SOLUCIÓN: Si es un string (ej. "2026-04-20" o "2026-04-20T00:00:00Z"),
  // separamos la fecha directamente ignorando la hora y la zona.
  ...
  // Fallback seguro si se pasa un objeto Date
