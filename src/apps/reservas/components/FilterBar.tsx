    ...
    <Paper elevation={0} sx={{ p: 2, mb: 2, border: "1px solid #e0e0e0", borderRadius: 2, backgroundColor: "#fff" }}>
      <Box sx={{ display: "flex", alignItems: "center", gap: 5, flexWrap: "wrap" }}>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
          ...
          <Box onClick={() => setMostrarFinesSemana(!mostrarFinesSemana)} sx={{ display: "inline-flex", alignItems: "center", justifyContent: "center", px: 1.5, py: 0.5, backgroundColor: mostrarFinesSemana ? "#004680" : "#f1f5f9", borderRadius: "10px", cursor: "pointer" }}>
