  ...
  return (
    ...
    >
        ...
        <Box sx={{ minWidth: { xs: '100%', lg: '120px' } }}>
          <Box
            ...
            sx={{
              ...
              borderRadius: 2,
              border: 'none',
              backgroundColor: (!codigoInput.trim() || loading || saving)
                ? theme.palette.grey[300]
                : theme.palette.primary.main,
              color: theme.palette.primary.contrastText,
              fontSize: '0.875rem',
              fontWeight: 600,
              cursor: (!codigoInput.trim() || loading || saving)
                ? 'not-allowed'
                : 'pointer',
              transition: 'all 0.2s',
              display: 'flex',
              ...
              '&:hover': {
                ...
                transform: (!codigoInput.trim() || loading || saving)
                  ? 'none'
                  : 'translateY(-1px)',
                boxShadow: (!codigoInput.trim() || loading || saving)
                  ? 'none'
                  : theme.shadows[4],
              },
              '&:active': {
      ...
      >
        ...
        >
          Ingrese el código de 4 dígitos del empleado y seleccione el cargo correspondiente.
          El sistema validará automáticamente la información antes de agregarlo a la lista.
        </Typography>
      </Box>
    </Box>
  );
